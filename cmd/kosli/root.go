...
The service principal needs to have the following permissions:  
  ...
  2) Microsoft.ContainerRegistry/registries/pull/read  
	...
	githubRequireApproverNotCommitterFlag = "[defaulted] Set the attestation to non-compliant if the PR has not been approved by any one other than the commit-author. (default: false)"
